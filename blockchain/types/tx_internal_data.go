...
type StateDB interface {
	...
	CreateSmartContractAccount(addr common.Address, isIstanbul bool)
	CreateSmartContractAccountWithKey(addr common.Address, humanReadable bool, key accountkey.AccountKey, isIstanbul bool)
